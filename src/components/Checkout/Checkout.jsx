...
const Checkout = () => {
  ...
  const paymentSubmit = () => {
    if (
      ...
      toast.error("Por favor, escolha o seu endereço de entrega!");
    } else {
      ...
      // atualize o armazenamento local com a matriz de pedidos atualizada
  ...
  // este é o custo de envio variável
  ...
  return (
    <div className="w-full flex flex-col items-center py-8">
      ...
      >
        <h5 className="text-white">Ir para Pagamento</h5>
      </div>
    </div>
  );
};
...
const ShippingInfo = ({
  ...
  return (
    <div className="w-full 800px:w-[95%] bg-white rounded-md p-5 pb-8">
      <h5 className="text-[18px] font-[500]">Endereço para envio</h5>
      <br />
      <form>
        ...
        <div className="w-full flex pb-3">
          ...
          <div className="w-[50%]">
            <label className="block pb-2">Estado</label>
            <select
              className="w-[95%] border h-[40px] rounded-[5px]"
              value={city}
  ...
  return (
    <div className="w-full bg-[#fff] rounded-md p-5 pb-8">
      <div className="flex justify-between">
        ...
        <h5 className="text-[18px] font-[600]">R${subTotalPrice}</h5>
      </div>
      <br />
      <div className="flex justify-between">
